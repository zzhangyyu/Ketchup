...
Page({
  ...
  onLoad: function(option) {
    ...
    networkUtil.postJson(getApp().globalData.baseUrl +"patient/getConsiliaNameIntro", reqJson, "正在加载...", that.onGetConsiliaNameIntroSuccess, that.onGetConsiliaNameIntroFail);
  },
  /**
   * 获取数据成功事件
   */
